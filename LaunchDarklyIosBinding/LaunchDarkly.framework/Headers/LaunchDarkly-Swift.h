...
#ifndef LAUNCHDARKLY_SWIFT_H
#define LAUNCHDARKLY_SWIFT_H
...
SWIFT_CLASS("_TtC12LaunchDarkly22LDInvalidArgumentError")
...
@property (nonatomic, readonly, copy) NSString * _Nonnull key;
/// The secondary key for the user. See the <a href="https://docs.launchdarkly.com/home/managing-flags/targeting-users#percentage-rollout-logic">documentation</a> for more information on it’s use for percentage rollout bucketing.
